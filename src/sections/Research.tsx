            ...
            <div className="grid md:grid-cols-2 gap-8">
                {researchPapers.map((paper, index) => (
                    <a
                        ...
                        className="group block bg-white dark:bg-darkCard p-6 md:p-8 rounded-lg shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-gray-100 dark:border-transparent"
                    >
